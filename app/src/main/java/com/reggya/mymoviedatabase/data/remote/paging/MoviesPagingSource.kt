...
@Singleton
class MoviesPagingSource @Inject constructor(private val apiService: ApiService, private val genreId: Int): PagingSource<Int, Movie>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Movie> {
        ...
        return try {
            val client = apiService.getMoviesByGenre(BuildConfig.API_KEY, genreId, pageIndex)
